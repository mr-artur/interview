...
## Atomicity
+ Принцип атомарности гарантирует, что транзакция выполняется как единое целое, то есть либо все изменения, внесенные транзакцией, будут применены, либо все они будут откачены.
