...
+ `merge (Object object) -> Object` - преобразует объект из _detached_ в _persistent_.
    + Загружает объект из БД, присоединяет к сессии, а при сохранении (флаше) выполняет запрос `UPDATE`.
